...
const FounderSection = () => (
  <section className="py-20 md:py-28 px-6">
    <div className="max-w-4xl mx-auto">
      <AnimatedSection>
        <p className="text-sm font-bold uppercase tracking-widest text-brand mb-4 font-display">
      ...
      <div className="mt-12 flex flex-col md:flex-row items-center gap-10 md:gap-14">
        <AnimatedSection delay={0.1} className="flex-shrink-0">
          <div className="w-56 h-56 md:w-64 md:h-64 rounded-full overflow-hidden border-2 border-brand/30">
            <img
              src={founderImg}
        ...
        <AnimatedSection delay={0.2} className="text-center md:text-left">
          ...
          <p className="text-sm text-brand font-semibold uppercase tracking-wide font-display mb-4">
            FOUNDER
          </p>
