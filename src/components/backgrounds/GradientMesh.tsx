...
const variants: Record<string, BlobConfig[]> = {
  hero: [
    ...
    { size: 350, color: "hsl(217 80% 60%)", startX: "50%", startY: "-5%", blur: 50, opacity: 0.12, path: { x: [0, -150, 250, -200, 100, 0], y: [0, 250, 150, 350, 50, 0] }, scale: [1, 1.1, 0.92, 1.05, 0.88, 1], duration: 28 },
    { size: 300, color: "hsl(42 50% 55%)", startX: "85%", startY: "55%", blur: 45, opacity: 0.14, path: { x: [0, -350, -150, -400, -100, 0], y: [0, -200, 50, -150, -250, 0] }, scale: [1, 0.9, 1.15, 0.88, 1.08, 1], duration: 32 },
    { size: 250, color: "hsl(42 65% 65%)", startX: "15%", startY: "35%", blur: 40, opacity: 0.1, path: { x: [0, 200, 400, 150, 350, 0], y: [0, -100, 200, -50, 150, 0] }, scale: [1, 1.2, 0.88, 1.12, 0.9, 1], duration: 26 },
  ],
  stats: [
    ...
    { size: 400, color: "hsl(217 80% 60%)", startX: "20%", startY: "-5%", blur: 55, opacity: 0.13, path: { x: [0, 300, 150, 400, 200, 0], y: [0, 300, 150, 250, 50, 0] }, scale: [1, 0.88, 1.12, 0.92, 1.08, 1], duration: 34 },
    { size: 280, color: "hsl(42 50% 55%)", startX: "60%", startY: "65%", blur: 45, opacity: 0.16, path: { x: [0, -250, 100, -350, 50, 0], y: [0, -250, -100, -200, -300, 0] }, scale: [1, 1.18, 0.85, 1.1, 0.9, 1], duration: 29 },
  ],
  pricing: [
    ...
    { size: 320, color: "hsl(42 65% 65%)", startX: "-5%", startY: "10%", blur: 48, opacity: 0.14, path: { x: [0, 450, 300, 500, 200, 0], y: [0, 100, 300, 50, 250, 0] }, scale: [1, 0.9, 1.12, 0.88, 1.1, 1], duration: 31 },
    { size: 280, color: "hsl(217 80% 60%)", startX: "35%", startY: "75%", blur: 42, opacity: 0.12, path: { x: [0, 200, -100, 300, -150, 0], y: [0, -300, -150, -250, -50, 0] }, scale: [1, 1.15, 0.9, 1.05, 0.92, 1], duration: 28 },
  ],
  cta: [
    ...
    { size: 350, color: "hsl(42 50% 55%)", startX: "85%", startY: "15%", blur: 52, opacity: 0.15, path: { x: [0, -400, -250, -350, -100, 0], y: [0, 200, 350, 150, 250, 0] }, scale: [1, 0.88, 1.12, 0.9, 1.08, 1], duration: 36 },
    { size: 260, color: "hsl(217 80% 60%)", startX: "20%", startY: "10%", blur: 40, opacity: 0.11, path: { x: [0, 300, 100, 350, 200, 0], y: [0, 250, 350, 100, 300, 0] }, scale: [1, 1.18, 0.85, 1.1, 0.92, 1], duration: 27 },
    { size: 200, color: "hsl(42 65% 65%)", startX: "50%", startY: "50%", blur: 35, opacity: 0.1, path: { x: [0, -200, 250, -150, 200, 0], y: [0, -200, 50, -300, -100, 0] }, scale: [1, 0.92, 1.15, 0.88, 1.1, 1], duration: 24 },
  ],
};
